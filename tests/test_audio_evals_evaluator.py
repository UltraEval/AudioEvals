...
def test_wer():
    ...
    for s0, s1 in [
        ('MISTER QUILTER IS THE APOSTLE OF THE MIDDLE CLASSES AND WE ARE GLAD TO WELCOME HIS GOSPEL', 'mister quilther is the apostle of the middle classes and we are glad to welcome his gospel<|endoftext|>'),
    ]:
        print(e(s1, s0))
...
def test_tmp():
    ...
    quiz = pd.read_json('/Users/a1/project/AudioEvals/raw_data/librispeech/dev_clean.jsonl', lines=True)
